...
class MyWindow(QDialog):
    def __init__(self, parent=None):
        ...
        self.setWindowTitle("Sniffer by SunJW")
        ...
        self.ui.tableView.horizontalHeader().setDefaultAlignment(Qt.AlignCenter)
        self.ui.tableView.horizontalHeader().setStretchLastSection(True)
        self.ui.tableView.setFixedHeight(400)
        ...
        for i in range(5):
            ...
            self.ui.tableView.setColumnWidth(i, 200)
    ...
    # 实现基础抓包
    def start(self):
        self.thread = Sniffer('\\Device\\NPF_'+self.ui.eth_comboBox.currentText())
        # self.thread = Sniffer('\Device\NPF_'+self.ui.eth_comboBox.currentText())
    ...
    def show_detail(self, item):
        ...
        self.ui.treeWidget.headerItem().setText(0, str(r_idx))
